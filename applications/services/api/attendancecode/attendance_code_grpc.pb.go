...
func (c *attendanceCodeProtoClient) GetAttendanceCode(ctx context.Context, in *wrappers.Int64Value, opts ...grpc.CallOption) (*AttendanceCode, error) {
	...
	err := c.cc.Invoke(ctx, "/attendancecode.AttendanceCodeProto/GetAttendanceCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *attendanceCodeProtoClient) CreateAttendanceCode(ctx context.Context, in *AttendanceCodeCreate, opts ...grpc.CallOption) (*AttendanceCode, error) {
	out := new(AttendanceCode)
	err := c.cc.Invoke(ctx, "/attendancecode.AttendanceCodeProto/CreateAttendanceCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AttendanceCodeProto_GetAttendanceCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/attendancecode.AttendanceCodeProto/GetAttendanceCode",
	}
...
func _AttendanceCodeProto_CreateAttendanceCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/attendancecode.AttendanceCodeProto/CreateAttendanceCode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var AttendanceCodeProto_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "attendancecode.AttendanceCodeProto",
